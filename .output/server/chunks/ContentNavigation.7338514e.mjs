...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db.725676c6.mjs').then((m) => m.generateNavigation);
...
defineAsyncComponent(() => import('./ContentDoc.39955c2d.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentList.9aeb743f.mjs').then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => ContentNavigation).then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentQuery.5c4c730a.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRenderer.0ae2fc44.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRendererMarkdown.b825e279.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentSlot.5110ad16.mjs').then((c) => c.default || c));
...
defineAsyncComponent(() => import('./Markdown.063fe479.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseA.f51ca111.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseBlockquote.34e10d00.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCode.2e49cdfe.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCodeInline.4bd03e33.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseEm.036c73e0.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH1.9ed8b51d.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH2.53632e1c.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH3.1dc99bb1.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH4.7447c2a1.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH5.c3dc9458.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH6.483a5518.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseHr.fff545f2.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseImg.4debdb73.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseLi.f0e404f7.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseOl.f4562d8a.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseP.2ce599f8.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseStrong.d8a1a401.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTable.33edfecb.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTbody.8a3dc807.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTd.0572e849.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTh.a9418590.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseThead.35ac1b0b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTr.7888a7c4.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseUl.1516220e.mjs').then((c) => c.default || c));
...
//# sourceMappingURL=ContentNavigation.7338514e.mjs.map
