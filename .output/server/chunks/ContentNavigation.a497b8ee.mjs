import { g as useNuxtApp, h as useState, i as useContentDisabled, b as useAsyncData, d as withContentBase, e as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify, f as useCookie, a as useHead, _ as _export_sfc, k as __nuxt_component_0$2 } from './server.mjs';
import { defineComponent, ref, onErrorCaptured, createElementBlock, h, computed, defineAsyncComponent, toRefs, useSlots, useSSRContext, mergeProps, createElementVNode } from 'vue';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db.1baab964.mjs').then((m) => m.generateNavigation);
...
defineAsyncComponent(() => import('./ContentDoc.5e5732a6.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentList.3a4f2a52.mjs').then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => ContentNavigation).then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentQuery.dee1d63b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRenderer.dde4f3e1.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRendererMarkdown.eddbf0cb.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentSlot.ba2ae505.mjs').then((c) => c.default || c));
...
defineAsyncComponent(() => import('./Markdown.66d3b2aa.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseA.cabf9bb0.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseBlockquote.061bbec5.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCode.c6ce39bd.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCodeInline.5f77b13b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseEm.35e65214.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH1.f5fae962.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH2.6700f47f.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH3.0fa38de7.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH4.403cfe72.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH5.e2bbcf53.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH6.d6b2cb13.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseHr.a0d0718e.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseImg.4debdb73.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseLi.170cced9.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseOl.c87528fa.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseP.4e9a0560.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseStrong.7cd75ae0.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTable.a0143853.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTbody.80d09d34.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTd.8658a7ad.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTh.ffc8a919.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseThead.6611134e.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTr.cb6b2dae.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseUl.7d8d4629.mjs').then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => welcome$1).then((c) => c.default || c));
defineAsyncComponent(() => import('./server.mjs').then((n) => n.D).then((c) => c.default || c));
...
defineAsyncComponent(() => import('./server.mjs').then((n) => n.B).then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => nuxtLoadingIndicator$1).then((c) => c.default || c));
defineAsyncComponent(() => import('./server.mjs').then((n) => n.I).then((c) => c.default || c));
defineAsyncComponent(() => import('./server.mjs').then((n) => n.E).then((c) => c.default || c));
...
//# sourceMappingURL=ContentNavigation.a497b8ee.mjs.map
